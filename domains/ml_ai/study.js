...
const TOPICS = {
  "what-is-ml": {
    ...
    content: `
      ...
      <img src="images/ml-types-diagram.png" alt="Diagram showing the four types of machine learning — supervised, unsupervised, semi-supervised, and reinforcement learning — with example applications for each">
  ...
  "supervised-learning": {
    ...
    content: `
      ...
      <img src="images/classification-example.png" alt="Scatter plot showing two categories of data points and a new data point being classified based on its nearest neighbors">
      ...
      <img src="images/sigmoid-function.png" alt="Graph of the sigmoid function, an S-shaped curve mapping any input to a value between 0 and 1">
      ...
      <img src="images/decision-tree-example.png" alt="Simple decision tree flowchart asking whether a person is fit, branching on age, pizza consumption, and morning exercise">
      <ul>
